  ...
  return (
    <DashboardLayout>
      ...
      <Box sx={{
        ...
        >
          <WaterDropIcon sx={{ fontSize: 120, color: theme.palette.primary.main }} />
        </motion.div>
        ...
        >
          <ScienceIcon sx={{ fontSize: 100, color: theme.palette.secondary.main }} />
        </motion.div>
        ...
        >
          <HealthAndSafetyIcon sx={{ fontSize: 80, color: theme.palette.primary.main }} />
        </motion.div>
        ...
        >
          <LocalHospitalIcon sx={{ fontSize: 90, color: theme.palette.secondary.main }} />
        </motion.div>
      </Box>
        ...
        {result && !loading && (
          <Box sx={{
            ...
            <Grid container spacing={3} sx={{ mb: 6 }}>
              {[
                { label: "Possible Conditions", value: result.prediction, color: theme.palette.primary.main },
                ...
                { label: "Next Steps", value: result.is_danger ? 'Schedule Checkup' : 'Continue Monitoring', color: theme.palette.primary.main },
              ].map((card, idx) => (
            ...
            >
              <AnimatedCard
                sx={{
                  borderRadius: 0,
                  border: 2,
                  borderColor: result.is_danger ? theme.palette.primary.main : theme.palette.secondary.main,
                  ...
                  >
                    <Avatar
                      sx={{
                        ...
                        mx: "auto",
                        mb: 2,
                        bgcolor: result.is_danger ? theme.palette.primary.main : theme.palette.secondary.main,
